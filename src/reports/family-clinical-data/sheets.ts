...
const phenotypes: SheetConfig = {
    ...
    columns: [
        ...
        },
        {
            ...
            transform: (value: string, _): string => (value ? 'Observed' : 'Not Observed'),
        },
        {
...
const sheetConfigs: SheetConfig[] = [participants, phenotypes, diagnoses];

export default sheetConfigs;
